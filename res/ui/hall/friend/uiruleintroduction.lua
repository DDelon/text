...
--Create spr_title
local spr_title = cc.Sprite:create("hall/friend/fr_pic_title_gzjs.png")
...
spr_title:setPosition(0.0017, 215.9955)
layout = ccui.LayoutComponent:bindLayoutComponent(spr_title)
layout:setSize({width = 160.0000, height = 42.0000})
layout:setLeftMargin(-79.9983)
layout:setRightMargin(-80.0017)
layout:setTopMargin(-236.9955)
...
btn_close:setTag(606)
btn_close:setCascadeColorEnabled(true)
btn_close:setCascadeOpacityEnabled(true)
btn_close:setPosition(369.7254, 228.3158)
layout = ccui.LayoutComponent:bindLayoutComponent(btn_close)
layout:setSize({width = 70.0000, height = 70.0000})
layout:setLeftMargin(334.7254)
layout:setRightMargin(-404.7254)
layout:setTopMargin(-263.3158)
layout:setBottomMargin(193.3158)
